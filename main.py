...
def funkcija():
    ...
    return bottle.template(
        "tpl/osebna_stran.tpl",
        {"ime": uporabnisko_ime, "gospodinjstva": moja_gospodinjstva},
    )
...
def prijava():
    ...
    if uporabnik is None:
        return bottle.template(
            "tpl/napaka.tpl",
            naslov="Napaka pri prijavi",
            opis="Uporabniško ime ali geslo ni ustrezno!",
            gumb="Nazaj na prijavo",
            povezava="/prijava",
        )
    else:
...
def registracija():
    ...
    try:
        ...
        return bottle.template(
            "tpl/napaka.tpl",
            naslov="Napaka pri registraciji",
            opis=str(e),
            gumb="Poskusi ponovno",
            povezava="/registracija",
        )
...
def zamenjaj_geslo():
    ...
    try:
        ...
        return bottle.template(
            "tpl/napaka.tpl",
            naslov="Napaka pri menjavi gesla",
            opis=str(e),
            gumb="Poskusi ponovno",
            povezava="/zamenjaj_geslo",
        )
...
def indeks(ime_gospodinjstva):
    ...
    return bottle.template(
        "tpl/ze_obstaja.tpl", {"ime_gospodinjstva": ime_gospodinjstva, "ime": ime}
    )
...
def pridruzi_se():
    ...
    if gospodinjstvo is None:
        return bottle.template(
            "tpl/napaka.tpl",
            naslov="Napaka pri pridružitvi gospodinjstvu",
            opis="To gospodinjstvo ne obstaja.",
            gumb="Poskusi ponovno.",
            povezava="/pridruzi_se",
        )
    ...
    try:
        ...
        return bottle.template(
            "tpl/napaka.tpl",
            naslov="Napaka pri pridružitvi gospodinjstvu",
            opis="Ste že član tega gospodinjstva! Ne morete se prodružiti ponovno.",
            gumb="Nazaj na osebno stran.",
            povezava="/osebna_stran",
        )
...
def indeks(ime):
    ...
    return bottle.template(
        "tpl/stran_gospodinjstva.tpl",
        {
            "ime": uporabnisko_ime,
            "ime_gospodinjstva": ime,
            "clani": gospodinjstvo.clani,
            "jedi": gospodinjstvo.jedi,
            "jedilniki": gospodinjstvo.jedilniki,
        },
    )
...
def zgeneriraj_jedilnik(ime):
    ...
    try:
        ...
        return bottle.template(
            "tpl/napaka.tpl",
            naslov="Napaka pri generiranju jedilnika",
            opis="V bazi jedi tega gospodinjstva še ni dovolj jedi. Najprej dodajte zadostno količino jedi v bazo, nato pa poskusite ponovno.",
            gumb="Nazaj na stran gospodinjstva.",
            povezava=f"/stran_gospodinjstva/{ime}",
        )
    return bottle.redirect(f"/stran_gospodinjstva/{ime}")
...
def indeks(ime_gospodinjstva):
    ...
    return bottle.template(
        ...
        {
            "ime": uporabnisko_ime,
            "ime_gospodinjstva": ime_gospodinjstva,
            "jedilniki": gospodinjstvo.jedilniki,
        },
    )
