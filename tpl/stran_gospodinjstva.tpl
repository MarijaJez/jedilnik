        ...
        <div class="row">
            <div class="column middle">
                ...
                %for ime_jedi in jedi:
                    ...
                    % vizbrano = "vizbrano" if ime in ime_jedi["všeč"] else "neizbrano"
                    % nizbrano = "nizbrano" if ime in ime_jedi["ni všeč"] else "neizbrano" 
                    <a class="gumbek1 {{vizbrano}}" href="/všečkaj/{{ime_gospodinjstva}}/{{ime_jedi['ime_jedi']}}"> Všečkaj </a>
                    <a class="gumbek1 {{nizbrano}}" href="/nevšečkaj/{{ime_gospodinjstva}}/{{ime_jedi['ime_jedi']}}"> Nevšečkaj </a>
                    <a class="gumbek1" href="/izbriši_jed/{{ime_gospodinjstva}}/{{ime_jedi['ime_jedi']}}"> Izbriši </a>
                    </li>
                %end
                </ul>
