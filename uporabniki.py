...
def poisci(uporabnisko_ime, geslo):
    """
    Ta funkcija pogleda v seznam vseh uporabnikov in ugotovi, ali obstaja uporabnik z
    danim uporabniškim imenom in geslom. Če obstaja, ga vrne, sicer vrne None.

    Keyword arguments:
    - uporabnisko_ime -- str 
    - geslo -- str - geslo v golem besedilu
    """
...
def doddaj( uporabnisko_ime, geslo):
